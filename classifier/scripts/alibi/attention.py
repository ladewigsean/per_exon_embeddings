...
class ALiBiMultiHeadAttention(nn.Module):
    ...
    # BUG FIX: Added ``padding_mask`` parameter.  Previously the ALiBi
    # attention had no way to ignore padded positions — they contributed
    # to attention scores as if they were real tokens.
